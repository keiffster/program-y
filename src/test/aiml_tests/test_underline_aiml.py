...
class BasicTestClient(TestClient):
    ...
    def load_configuration(self, arguments):
        ...
        self.configuration.brain_configuration._aiml_files = BrainFileConfiguration("/Users/keithsterling/Documents/Development/Python/Projects/AIML/program-y/src/test/aiml_tests/test_files/underline", ".aiml", False)

...
class BasicTestClient(TestClient):
    ...
    def load_configuration(self, arguments):
        ...
        self.configuration.brain_configuration._denormal = "/Users/keithsterling/Documents/Development/Python/Projects/AIML/program-y/bots/keiff/config/denormal.txt"

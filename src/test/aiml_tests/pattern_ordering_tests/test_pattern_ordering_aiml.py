...
class OrderingAIMLTests(unittest.TestCase):
    ...
    def setUp(self):
        ...
        OrderingAIMLTests.test_client.bot.brain.sets._sets["COLOR"] = ["RED"]
        OrderingAIMLTests.test_client.bot.brain.sets._sets["ANIMAL"] = ["DOLHIN"]
    ...
    def test_hash_v_star(self):
        ...
        response = OrderingAIMLTests.test_client.bot.ask_question("test",  "MY FAVORITE ANIMAL IS A DOLHIN")

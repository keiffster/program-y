...
class ConfigurationBaseFileTests(unittest.TestCase):
    ...
    def assert_configuration(self, configuration):
        ...
        self.assertEqual(configuration.brain_configuration.files.predicates, "./config/test-predicates.txt")
        self.assertEqual(configuration.brain_configuration.files.pronouns, "./config/test-pronouns.txt")

...
class FileStorageConfigurationTests(unittest.TestCase):
    ...
    def test_initialise_with_config(self):
        ...
        yaml.load_from_text("""
                config:
                    ...
                    usergroups_storage:
                      file: ./storage/security/usergroups.txt
                      format: text
                      encoding: utf-8                 
                      delete_on_start: false            
    ...
    def test_create_storage_defaults(self):
        ...
        self.assert_config(amap['sets_storage'], dirs=["./storage/sets"], extension="txt", subdirs=False, format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['maps_storage'], dirs=["./storage/maps"], extension="txt", subdirs=False, format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['rdf_storage'], dirs=["./storage/rdfs"], extension="txt", subdirs=True, format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['denormal_storage'], file="./storage/lookups/denormal.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['normal_storage'], file="./storage/lookups/normal.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['gender_storage'], file="./storage/lookups/gender.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['person_storage'], file="./storage/lookups/person.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['person2_storage'], file="./storage/lookups/person2.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['regex_storage'], file="./storage/lookups/regex.txt", format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['properties_storage'], file="./storage/properties.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['defaults_storage'], file="./storage/defaults.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['variables_storage'], dirs=["./storage/variables"], extension="txt", subdirs=False, format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['twitter_storage'], dirs=["./storage/twitter"], extension="txt", subdirs=False, format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['spelling_storage'], file="./storage/spelling/corpus.txt", format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['license_storage'], file="./storage/licenses/license.keys", format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['pattern_nodes_storage'], file="./storage/nodes/pattern_nodes.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['template_nodes_storage'], file="./storage/nodes/template_nodes.txt", format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['binaries_storage'], file="./storage/braintree/braintree.bin", format="binary", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['braintree_storage'], file="./storage/braintree/braintree.xml", format="xml", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['preprocessors_storage'], file="./storage/processing/preprocessors.txt", format="text", encoding="utf-8", delete_on_start=False)
        self.assert_config(amap['postprocessors_storage'], file="./storage/processing/postprocessors.txt", format="text", encoding="utf-8", delete_on_start=False)

        self.assert_config(amap['usergroups_storage'], file="./storage/security/usergroups.txt", format="text", encoding="utf-8", delete_on_start=False)

...
class FilePerson2StoreTests(LookupStoreAsserts):
    ...
    def test_load_from_file(self):
        ...
        self.assertEquals(person2_collection.person(" I WAS "), [re.compile('(^I WAS | I WAS | I WAS$)', re.IGNORECASE), ' HE OR SHE WAS '])

...
class LinkTests(unittest.TestCase):
    ...
    def test_init_no_id_no_expiration(self):
        ...
        self.assertEqual({'expired': None, 'expires': None, 'generated_key': 'ABCDEF123', 'primary_user': 'keiffster', 'provided_key': 'PASSWORD123'}, link.to_document())

    def test_init_no_id_no(self):
        link = Link("keiffster", "ABCDEF123", "PASSWORD123", expired=False, expires="12/12/2012")
        ...
        self.assertEqual({'expired': False, 'expires': "12/12/2012", 'generated_key': 'ABCDEF123', 'primary_user': 'keiffster', 'provided_key': 'PASSWORD123'}, link.to_document())
    ...
    def test_init(self):
        ...
        self.assertEqual({'_id': '666', 'expired': False, 'expires': "12/12/2012", 'generated_key': 'ABCDEF123', 'primary_user': 'keiffster', 'provided_key': 'PASSWORD123'}, link.to_document())

    def test_from_document(self):
        data1 = {"primary_user": "user1", "generated_key": "ABCDEFG", "provided_key": "1234567890", "expired": False, "expires": "12/12/2012"}
        ...
        data2 = {"_id": "666", "primary_user": "user1", "generated_key": "ABCDEFG", "provided_key": "1234567890", "expired": False, "expires": "12/12/2012"}

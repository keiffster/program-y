...
class DailyForecastDayDataPointTests(unittest.TestCase):
    ...
    def test_parse_json(self):
        ...
        self.assertEqual("WEATHER TYPE Day WINDDIR S WINDSPEED 9 WINDGUST 16 TEMP 15 FEELS 13 HUMID 54RAINPROB 0 UVINDEX 4 UVGUIDE Moderate exposure. Seek shade during midday hours, cover up and wear sunscreen VIS Very good - Between 20-40 km WEATHER Sunny day", dp.to_program_y_text())
    ...
    def test_parse_json_u_v_w_missing(self):
        ...
        self.assertEqual("WEATHER TYPE Day WINDDIR S WINDSPEED 9 WINDGUST 16 TEMP 15 FEELS 13 HUMID 54RAINPROB 0", dp.to_program_y_text())

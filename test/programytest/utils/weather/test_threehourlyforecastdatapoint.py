...
class ThreeHourlyForecastDataPointTests(unittest.TestCase):
    ...
    def test_parse_json(self):
        ...
        self.assertEqual("WEATHER Sunny day TEMP 4 FEELS 3 WINDSPEED 2 UVINDEX 1 UVGUIDE Low exposure. No protection required. You can safely stay outside RAINPROB 0 HUMIDITY 96 WINDDIR S WINDDIRFULL South VIS Moderate - Between 4-10 km", dp.to_program_y_text())
    ...
    def test_parse_json_s_u_v_w_missing(self):
        ...
        self.assertEqual("WEATHER TEMP 4 FEELS 3 WINDSPEED 2 UVINDEX None UVGUIDE None RAINPROB 0 HUMIDITY 96", dp.to_program_y_text())

...
class ObservationDataPointTests(unittest.TestCase):
    ...
    def test_parse_json(self):
        ...
        self.assertEqual("WEATHER Partly cloudy (day) TEMP 11 2 HUMIDITY 57 3 VISIBILITY V 35000 VF Very Good PRESSURE P 1021 PT R PTF Rising WIND D W DF West S 11", dp.to_program_y_text())
    ...
    def test_parse_json_V_D_W_Pt(self):
        ...
        self.assertEqual("WEATHER TEMP 11 2 HUMIDITY 57 3 PRESSURE P 1021 S 11", dp.to_program_y_text())

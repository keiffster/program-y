...
class PatternFactoryTests(unittest.TestCase):
    ...
    def test_match_no_word(self):
        ...
        self.assertEquals("Match=(Topic) Node=(ONEORMORE [*]) Matched=()", match.to_string(self._client_context.brain.tokenizer))
    ...
    def test_match_word(self):
        ...
        self.assertEquals("Match=(Topic) Node=(ONEORMORE [*]) Matched=(Hello)", match.to_string(self._client_context.brain.tokenizer))
    ...
    def test_match_multi_word(self):
        ...
        self.assertEquals("Hello World", match.joined_words(self._client_context.brain.tokenizer))
        self.assertEquals("Match=(Topic) Node=(ONEORMORE [*]) Matched=(Hello World)", match.to_string(self._client_context.brain.tokenizer))

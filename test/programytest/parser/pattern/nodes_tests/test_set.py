...
class PatternSetNodeTests(ParserTestsBaseClass):
    ...
    def test_init(self):
        ...
        self._bot.brain._sets_collection._sets["TEST1"] = loader.load_from_text("""
            VALUE1
            VALUE2
            VALUE3
            VALUE4
        ...
        sentence = Sentence(self._bot.brain.tokenizer, "VALUE1 VALUE2 VALUE3 VALUE4")
        ...
        self.assertEqual('<set name="TEST1">\n</set>', node.to_xml(self._bot, self._clientid))
    ...
    def test_multi_word_set(self):
        ...
        sentence = Sentence(self._bot.brain.tokenizer, "RED Red BROWN red AMBER")
        ...
        result = node.equals(self._bot, "testid", sentence, result.word_no+1)
        self.assertTrue(result.matched)
    ...
    def test_number(self):
        ...
        sentence = Sentence(self._bot.brain.tokenizer, "12 XY")

...
class RestBotClientTests(unittest.TestCase):
    ...
    def test_init(self):
        ...
        self.assertEquals("REST", client.bot.brain.properties.property("env"))
    ...
    def test_api_keys(self):
        ...
        client.configuration.client_configuration._api_key_file = os.path.dirname(__file__) + os.sep + "api_keys.txt"

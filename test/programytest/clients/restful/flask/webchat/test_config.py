...
class WebChatConfigurationTests(unittest.TestCase):
    ...
    def test_to_yaml_with_defaults(self):
        ...
        self.assertEquals(
            {'cookie_id': 'ProgramYSession', 'cookie_expires': 90, 'host': '0.0.0.0', 'port': 80, 'debug': False,
             'api': '/api/rest/v1.0/ask', 'use_api_keys': False, 'api_key_file': './api.keys',
    ...
    def test_to_yaml_with_no_defaults(self):
        ...
        self.assertEquals(
            {'cookie_id': 'ProgramYSession', 'cookie_expires': 90, 'host': '0.0.0.0', 'port': 80, 'debug': False,
             'api': '/api/rest/v1.0/ask', 'use_api_keys': False, 'api_key_file': None, 'ssl_cert_file': None,
             'ssl_key_file': None, 'authorization': None, 'description': 'ProgramY AIML2.0 Client',
             ...
             'responder': {'name': 'Client Ping Responder', 'host': None, 'port': None, 'ssl_cert_file': None,
                           'ssl_key_file': None, 'url': None, 'shutdown': None, 'register': None, 'unregister': None,
                           'debug': False}, 'renderer': 'programy.clients.render.html.HtmlRenderer',

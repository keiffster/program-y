...
class AlexaConfigurationTests(unittest.TestCase):
    ...
    def test_to_yaml_with_defaults(self):
        ...
        self.assertEquals(
            {'launch_text': 'Hello and welcome', 'launch_srai': None, 'stop_text': 'Good bye matey', 'stop_srai': None,
             'cancel_text': 'OK, what else can I do?', 'cancel_srai': None,
             'help_text': 'Ask me anything, I know loads', 'help_srai': None,
             'error_text': 'Oopsie there has been an error', 'error_srai': None,
             'leave_intents': 'AMAZON.StopIntent, AMAZON.CancelIntent', 'intent_map_file': None, 'host': '0.0.0.0',
             'port': 80, 'debug': False, 'api': '/api/rest/v1.0/ask', 'use_api_keys': False,
             'api_key_file': './api.keys', 'ssl_cert_file': './rsa.cert', 'ssl_key_file': './rsa.keys',
    ...
    def test_to_yaml_with_no_defaults(self):
        ...
        self.assertEquals(
            {'launch_text': 'Hello and welcome', 'launch_srai': None, 'stop_text': 'Good bye matey', 'stop_srai': None,
             ...
             'error_text': 'Oopsie there has been an error', 'error_srai': None,
             'leave_intents': 'AMAZON.StopIntent, AMAZON.CancelIntent', 'intent_map_file': None, 'host': '0.0.0.0',
             'port': 80, 'debug': False, 'api': '/api/rest/v1.0/ask', 'use_api_keys': False, 'api_key_file': None,

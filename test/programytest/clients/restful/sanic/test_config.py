...
class SanicRestConfigurationTests(unittest.TestCase):
    ...
    def test_to_yaml_with_defaults(self):
        ...
        self.assertEquals({'workers': 4, 'host': '0.0.0.0', 'port': 80, 'debug': False, 'api': '/api/rest/v1.0/ask',
                           'use_api_keys': False, 'api_key_file': './api.keys', 'ssl_cert_file': './rsa.cert',
                           'ssl_key_file': './rsa.keys', 'authorization': None,
                           'description': 'ProgramY AIML2.0 Client',
                           'bot_selector': 'programy.clients.botfactory.DefaultBotSelector',
                           'scheduler': {'name': 'scheduler', 'debug_level': 0, 'add_listeners': False,
                           ...
                           'responder': {'name': 'Client Ping Responder', 'host': None, 'port': None,
                                         'ssl_cert_file': None, 'ssl_key_file': None, 'url': None, 'shutdown': None,
                                         'register': None, 'unregister': None, 'debug': False},
                           'renderer': 'programy.clients.render.text.TextRenderer', 'storage': {
    ...
    def test_to_yaml_with_no_defaults(self):
        ...
        self.assertEquals({'workers': 4, 'host': '0.0.0.0', 'port': 80, 'debug': False, 'api': '/api/rest/v1.0/ask',
                           'use_api_keys': False, 'api_key_file': None, 'ssl_cert_file': None, 'ssl_key_file': None,
                           'authorization': None, 'description': 'ProgramY AIML2.0 Client',
                           'bot_selector': 'programy.clients.botfactory.DefaultBotSelector',
                           'scheduler': {'name': None, 'debug_level': 0, 'add_listeners': False,
                                         'remove_all_jobs': False, 'jobstore': {'name': None},
                                         'threadpool': {'max_workers': None}, 'processpool': {'max_workers': None},

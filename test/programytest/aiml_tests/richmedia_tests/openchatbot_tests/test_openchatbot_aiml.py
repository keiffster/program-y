...
class OpenChatBotAIMLTests(unittest.TestCase):
    ...
    def test_openchatbot(self):
        ...
        print(response)
        self.assertTrue(response.startswith("<tts><type>plainText</type> Je vous envoie+ d&apos;information sur le Strandmon de chez Ikea</tts> <card><title>Fauteuil enfant, Vissle"))

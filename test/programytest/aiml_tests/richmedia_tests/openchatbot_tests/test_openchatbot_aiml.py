...
class OpenChatBotAIMLTests(unittest.TestCase):
    ...
    def test_openchatbot(self):
        ...
        self.assertTrue(response.startswith("<tts><type>plainText</type> Je vous envoie+ d'information sur le Strandmon de chez Ikea</tts> <card><image>https://www.ikea.com"))
